...
<?php get_header(); ?>
	...
	<div class="u-gridContainer content-area">
		<div class="u-gridRow">					
			<img src="<?php echo get_stylesheet_directory_uri();?>/img/koop.jpg">
		</div>	
		...
		<div class="u-gridRow">	
			<div class="u-gridCol6">
				...
				<p>Meerprijs Honeywell touch <b>€ 140,-</b></p>
			</div>
			<div class="u-gridCol6">
				...
				<p>Meerprijs Honeywell round <b>€ 60,- </b></p>
			</div>
		</div>


		<div class="u-gridRow">	
			<img src="<?php echo get_stylesheet_directory_uri();?>/img/offerte-aanvraag.png">
		</div>
